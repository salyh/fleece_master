...
public class Copy3JsonStreamParserImpl implements JsonChars, EscapedStringAwareJsonParser {
    ...
    public Copy3JsonStreamParserImpl(final Reader reader, final int maxStringLength, final BufferStrategy.BufferProvider<char[]> bufferProvider,
