...
public class JsonStreamParserImpl_93_187_50_103 implements JsonChars, EscapedStringAwareJsonParser {
    ...
    public JsonStreamParserImpl_93_187_50_103(final Reader reader, final int maxStringLength, final BufferStrategy.BufferProvider<char[]> bufferProvider,
    ...
    private void handleQuote(final char c) {
        ...
        if (lastSignificantChar >= 0 && lastSignificantChar != I_KEY_SEPARATOR
                && lastSignificantChar != I_START_OBJECT_CHAR && lastSignificantChar != I_START_ARRAY_CHAR && lastSignificantChar != I_COMMA) {
            throw new JsonParsingException("Unexpected character " + c + " (last significant was " + lastSignificantChar + ")",
                    createLocation());
        }
